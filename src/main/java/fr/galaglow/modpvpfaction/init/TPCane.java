...
public class TPCane extends Item{
	...
	public TPCane()
	{
		...
		this.setCreativeTab(PvpMod.PvpTab);
	}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_)
	{
		...
		{
			p_77659_2_.playSoundAtEntity(p_77659_3_, "random.bow", 0.1F, 0.1F / (itemRand.nextFloat() * 0.1F + 0.1F));
